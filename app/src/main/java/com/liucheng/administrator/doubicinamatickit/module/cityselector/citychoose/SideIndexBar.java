...
import com.liucheng.administrator.doubicinamatickit.module.cityselector.manager.DisplayUtil;
...
public class SideIndexBar extends View {
	...
	private void init(Context context, AttributeSet attrs) {
		...
		mPaint.setTextSize(DisplayUtil.sp2px(context, 12));
	...
	protected void onDraw(Canvas canvas) {
		for (int i = 0, len = mLetters.length; i < len; i++) {
			...
			mPaint.setColor(Color.parseColor("#50B3DA"));
